									...
									'<div class="modal-content">' +
										'<div class="modal-body">' +
												...
												'<div class="dtp-date">' +
													'<div class="row">' +
														'<div class="col-sm-2 col-xs-2">' +
															'<a href="javascript:void(0);" class="dtp-select-month-before"><span class="fa fa-angle-left white_txt"></span></a>' +
														'</div>' +
														'<div class="col-sm-8 col-xs-8 dtp-actual-month">APR</div>' +
														'<div class="col-sm-2 col-xs-2">' +
															'<a href="javascript:void(0);" class="dtp-select-month-after"><span class="fa fa-angle-right  white_txt"></span></a>' +
														'</div>' +
													'</div>' +
													'<div class="dtp-actual-num">13</div>' +
													'<div class="row">' +
														'<div class="col-sm-2 col-xs-2">' +
															'<a href="javascript:void(0);" class="dtp-select-year-before"><span class="fa fa-angle-left white_txt"></span></a>' +
														'</div>' +
														'<div class="col-sm-8 col-xs-8 dtp-actual-year">2014</div>' +
														'<div class="col-sm-2 col-xs-2">' +
															'<a href="javascript:void(0);" class="dtp-select-year-after"><span class="fa fa-angle-right  white_txt"></span></a>' +
														'</div>' +
													'</div>' +
												'</div>' +
											...
											'<div class="dtp-buttons">' +
												'<button class=" b_btn dtp-btn-ok pull-right btn btn-flat">OK</button>' +
												'<button class=" b_btn dtp-btn-cancel pull-right btn btn-flat">CANCEL</button>' +
